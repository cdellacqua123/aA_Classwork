// addNumbers
// Let's write a function that will read several numbers, one after another, and sum up the total.
//  After each number, let's print out the partial sums along the way, and pass the total sum to a callback when done.

// First off, use readline.createInterface to create a global variable, reader.Use process.stdin / 
// process.stdout like I do in my examples.Make sure to only use one instance of a reader and only close it once.
